            ...
            try {
                ...
                Papa.parse(text, {
                    ...
                    complete: (results) => {
                        ...
                        setTextBoxContent(`${yearText}\n\nData collection stops May 2024.`);
    ...
    return (
        <div className="chart-container">
            <div className="chart-header">
                <h2 style={{ flex: 1, textAlign: 'center' }}>Application Usage Over Time by Month</h2>
                <div className="data-box">
                    2021: Analytics 16.8% 2022: Analytics 34.9% 2023: Analytics 39.2% 2024: Analytics 34.4% Data collection stops May 2024.
                </div> 
            </div>
            <Bar data={data} options={options} />
        </div>
...
const Graph3 = () => {
    ...
    return (
        <div className="chart-container">
            <h2>Analytics Activity by Year vs Total Work</h2>
            <Bar data={data} options={options} />
        </div>
    );
};
